...
<div class="row">
	<%-- <div class="col-md-12"> --%>
		...
		<div class="col-md-4">
			<div class="md-form form-group">
				<input type="text" id="ubTpoInmu${noUb}" name="ubTpoInmu${noUb}" class="form-control"
					value="${tpoInmueble[noUb]}" disabled>
				<label for="ubTpoInmu${noUb}">
		...
		<div class="col-md-4">
			<div class="md-form form-group">
				<input type="text" id="ubTpoUso${noUb}" name="ubTpoUso${noUb}" class="form-control"
					value="${tpoUso[noUb]}" disabled>
				<label for="ubTpoUso${noUb}">
